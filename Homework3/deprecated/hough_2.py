...
def accumulate_gradients(r_table, grayImage):
    '''
    Perform a General hough_tranform Transform with the given image and R-table
    '''
...
def test():
    ...
    reference_image = imread("images/empire.png", flatten=True)
    detect_s = general_hough_closure(reference_image)
    #test_general_hough(detect_s, reference_image, "images/s_test.png")
    test_general_hough(detect_s, reference_image, "images/images.jpg")
